...
RcppExport SEXP TwoPhase_MLE0_MEXY_CV_loglik (SEXP Y_tilde_R, SEXP X_tilde_R, SEXP Y_R, SEXP X_R, SEXP Z_R, SEXP Bspline_R, SEXP MAX_ITER_R, SEXP TOL_R, SEXP Train_R) 
{
	/*#############################################################################################################################################*/
	/**** pass arguments from R to cpp *************************************************************************************************************/
	const MapVecd Y_tilde(as<MapVecd>(Y_tilde_R));
